...
public class ExpedirPage extends ExpedirMap {
	...
	public ExpedirPage crearExpedir(File folderPath, String n, String t, String o, String informacionG)
		...
		t = driver.findElement(By.xpath(
				"//*[@id='contenido']/app-main/app-formulario/div/form/accordion/accordion-group[4]/div/div[2]/div/div[2]/div/table/tbody/tr[1]/td[2]"))
				.getText();
		o = driver.findElement(By.xpath(
				"//*[@id='contenido']/app-main/app-formulario/div/form/accordion/accordion-group[4]/div/div[2]/div/div[2]/div/table/tbody/tr[1]/td[5]"))
				.getText();
	...
	public ExpedirPage modificarExpedir(File folderPath, String titulo, String poliza, String tipoMercancia)
			throws Exception {
 ...
 /*
		if (Boolean.FALSE.equals(val)) {
			GenerarReportePdf.closeTemplate(
					"Error en la validación: No se encontró el mensaje del elemento " + lblGudadoExitoso);
 ...
 */
	...
	@Step("Ver expedir")
	public ExpedirPage ExpedirCancelar(File folderPath, String TituloCancelado, String Mercancias, String EstadoC,
			String CantInicial, String CantActual) throws Exception {
		...
		searchElementGrid1(ClientEstatus1, EstadoC, folderPath,
				"Se valida estado de titulo como cancelado Caso 543825");
	...
	@Step("Ver expedir")
	public ExpedirPage ValidacionLiberacion_543826(File folderPath, String TituloLiberacion, String Detalle,
			String EstadoC, String CantInicial, String CantActual, String LiberarCantidad, String Sinicial,
			String TituloHistorico, String TituloLiberacionInicial, String Mercancias) throws Exception {
		...
		scrollElementV(folderPath, locatorVariable(lblCamposDetalleMercancia, "Cant. Inicial"),
				"Se desplaza hasta el campo detalle de mercancia");
		...
		scrollElementV(folderPath, locatorVariable(lblCamposDetalleMercancia, "Valor Total"),
				"Click en opciones titulo");
		...
		writeText(txtNitCargue, TituloHistorico, folderPath,
				"Se escribe el titulo a buscar, 546945 se consulta titulo en estado cancelado o aplicado");
		scrollElementH(folderPath, lblModificarHistorico, "Se desplaza hasta modificar");
		searchElementGrid1(AlternativeGridstatus, EstadoC, folderPath,
				"Se valida el estado aplicado del titulo del caso 546943");
	...
	@Step("Ver expedir")
	public ExpedirPage ValidacionMercanciaLiberada(File folderPath, String TituloLiberado, String Detalle,
			String CantInicial, String CantActual, String TituloCancelado) throws Exception {
		...
		scrollElementV(folderPath, locatorVariable(lblOpciones2, " Mercancías "),
				"Se desplaza hacia la opcion mercancias");
		click(locatorVariable(lblOpciones2, " Mercancías "), folderPath, "Click en Mercancias");
		searchElementGrid1(ClienteMercanciaState, CantInicial, folderPath,
				"Caso 543829,543830 exitoso se validan campos, Se valida que el valor esta en 0");
		searchElementGrid1(ClienteMercanciaState, CantActual, folderPath,
				"Caso 543829,543830 exitoso se validan campos, Se valida que el valor esta en 0");
		...
		ValidacionObjeto(validarbtncargarf,
				"Se valida que el titulo ya no tiene liberaciones del caso 543829 caso exitoso", folderPath);
	...
	public ExpedirPage ObjetoPresente(File folderPath, String TituloaLiberar, String Detalle) throws Exception {
		 ...
		 * 
		 * click(locatorVariable(lblOpciones2, " Detalle de mercancía "), folderPath,
		 * "Click en Mercancias"); searchElementGrid1(ClienteMercanciaState,
		 * CantInicial, folderPath,
		 * "Caso 543829,543830,543831 exitoso se validan campos, Se valida que el valor esta en 0"
		 * ); searchElementGrid1(ClienteMercanciaState, CantActual, folderPath,
		 * "Caso 543829,543830,543831,543832 exitoso se validan campos, Se valida que el valor esta en 0"
		 * );
		 * 
		 * click(locatorVariable(lblsecciones,"Expedir"),folderPath,""))
		 * writeText(txtBuscaTitulo, TituloaLiberar, folderPath, "");
		 * 
		 * click(locatorVariable(lblOpciones2, " Mercancia "), folderPath,
		 * "Click en Mercancias");
		 *
		 */
	...
	@Step("Ver expedir")
	public ExpedirPage ValidacionExpedirLiberacion(File folderPath, String TituloLiberado, String Detalle,
			String Mercancias) throws Exception {
	...
	@Step("Ver Bodega de cargue")
	public ExpedirPage ValidacionExpedicion_542372(File folderPath, String NitClienteAsociado, String TipoDato,
			String InformacionGeneral, String DetalleMercancia, String Plazo, String Poliza, String TipodeMercancia,
			String Mercancias, String Route, String RouteA, String RouteB, String ModuloT, String SubModuloExpedir,
		...
		searchElementGrid(FilaElemento2, ValorBuscado, folderPath,
				"Se encuentra Validacion de Bodega propia y wms, Caso 542372,542369");
		...
		writeText(txtNitCargue, NitClienteAsociado, folderPath, "Se escribe el nit que se desea buscar ");
		...
		click(locatorVariable(lblOpciones, InformacionGeneral), folderPath,
				"Click en menu opciones poliza y se visualizan los datos necesarios caso 542370,542372");
		click(locatorVariable(lblOpciones, InformacionGeneral), folderPath, "Click en menu opciones poliza");

		click(locatorVariable(lblOpciones, DetalleMercancia), folderPath,
				"Click en Detalle Mercancia y se visualizan los datos necesarios caso 542370,542372");

		click(locatorVariable(lblOpciones, DetalleMercancia), folderPath, "Click en Detalle Mercancia");

		desplazarseVertical(0, 250);
		click(locatorVariable(lblOpciones, Plazo), folderPath,
				"Click en Plazo y se visualizan los datos necesarios caso 542370,542372");
		click(locatorVariable(lblOpciones, Plazo), folderPath, "Click en Plazo");

		click(locatorVariable(lblOpciones, Poliza), folderPath,
				"Click en menu opciones poliza y se visualizan los datos necesarios caso 542370,542372");
		click(locatorVariable(lblOpciones, Poliza), folderPath, "Click en menu opciones poliza");

		desplazarseVertical(0, 300);

		click(locatorVariable(lblOpciones, TipodeMercancia), folderPath,
				"Click en tipo de mercancia y se visualizan los datos necesarios caso 542370,542372");
		click(locatorVariable(lblOpciones, TipodeMercancia), folderPath, "Click en tipo de mercancia");

		desplazarseVertical(0, 300);
		click(locatorVariable(lblOpciones, Mercancias), folderPath,
				"Click en Mercancias, Se valida el funcionamiento de la seccion mercancias del caso 542369");
		...
		ValidacionObjetos(validarbtndescarga, validarbtncargar,
				" Se valida la presencia de los botones de carge y descargue de archivos", folderPath);

		click(btnDescargar, folderPath,
				"click en boton descargar 542371,542372 , el caso 542370 se ejecuta correctamente");

		waitInMs(3);

		fileUpFull(btnCargue, Route);
		boolean validarAlertaCargueerrado = validarElemento(AlertaCargue, 10);
		ValidacionObjeto(validarAlertaCargueerrado,
				"caso 542371 se valida la existencia de la alerta de cargue no exitoso, no aparece una alerta de error sino de advertencia por tanto el caso 542371 falla",
				folderPath);

		fileUpFull(btnCargue, RouteA);
		boolean validarAlertaCargue = validarElemento(AlertaCargue, 10);
		ValidacionObjeto(validarAlertaCargue,
				"caso 542370 es exitoso ,542373 es exitoso,542375 se valida la existencia de la alerta de cargue exitoso, 542375 cargue de datos decimales esta prueba falla porque si permitio realizar la carga de archivos, Caso 542378 exitoso se carga esa cantidad de mercancias",
				folderPath);
		fileUpFull(btnCargue, RouteB);

		boolean validarAlertaCargue2 = validarElemento(AlertaCargue, 10);
		ValidacionObjeto(validarAlertaCargue2,
				"casos exitosos 542370,542373,542376, se valida la existencia de la alerta de cargue exitoso,caso 542376 falla porque no esta la tabla de calculo, valida cargue de caso 542377",
				folderPath);

		// No se puede jamas automatizar la creacion perpetua de titulos debido a que
		// estos solo cambian de estado y no es posible borrarlos como tal

		 //click(btnAplicar, folderPath, "click en boton descargar 542371,542372 , el"
		// caso 542370 se ejecuta correctamente");
		// click(btnAceptar, folderPath, "click en boton descargar 542371,542372 , el
		// caso 542370 se ejecuta correctamente");
		// click(btnSafe, folderPath, "click en boton descargar 542371,542372 , el caso
		// 542370 se ejecuta correctamente");
		// click(btnAceptar, folderPath, "click en boton descargar 542371,542372 , el
		// caso 542370 se ejecuta correctamente");
		// boolean validarAlertaCargue = validarElemento(AlertaCargue,10);
		// ValidacionObjeto(validarAlertaCargue,"caso 542370 se valida la existencia de
		// la alerta de cargue exitoso, caso 542377 es exitoso en el guardado de
		// cargue", folderPath);

		scrollElementV(folderPath, CheckBox,
				"Se dezplaza hasta checkbox, Se valido el funcionamiento de la funcion de cargue masivo y el checkbox del caso 542369, datos caso 542372,checkbox cargados 542374");

		fileUpFull(btnCargue, RouteC);

		boolean validarAlertaCargue3 = validarElemento(AlertaCargue, 10);

		ValidacionObjeto(validarAlertaCargue3,
				"caso 542492 exitoso se valida el mensaje de cargue exitoso de un archivo con cantidades negativas",
				folderPath);
	...
	@Step("Ver Bodega de cargue")
	public ExpedirPage ValidacionHistorico_546943(File folderPath, String TituloHistorico, String DetalleMercancia,
			String EstadoC, String Mercancias, String ValidarVisualizacionLiberacion, String CantInicial,
			String CantActual, String LiberarCantidad, String Sinicial, String etiquetaPoliza, String poliza,
			String TituloEjemplo, String TituloIncompleto, String TituloCancelado, String Producto) throws Exception {
		...
		searchElementGrid1(ClienteMercanciaState, CantInicial, folderPath,
				"caso 546943 exitoso se puede observar informacion");
		searchElementGrid1(ClienteMercanciaState, CantActual, folderPath,
				"caso 546943 exitoso se puede observar informacion");
		searchElementGrid1(ClienteMercanciaState, LiberarCantidad, folderPath,
				"caso 546943 exitoso se puede observar informacion");
		searchElementGrid1(ClienteMercanciaState, Sinicial, folderPath,
				"caso 546943 exitoso se puede observar informacion");
		...
		searchElementGrid1(gridLiberacion, ValidarVisualizacionLiberacion, folderPath,
				"caso 546943 exitoso se puede observar informacion");
		...
		ValidacionObjeto(btnVisualizarHistorico, "caso 546943,546947 se valida existencia de boton visualizar ",
				folderPath);
		click(lblVisualizarHistorico, folderPath,
				"click en visualizar liberacion,546945 se visualiza cantidad inicial");
		click(btnClose, folderPath, "cerrar consulta");

		click(locatorVariable(lblsecciones, "Expedir"), folderPath, "Click en Mercancias");
		writeText(txtNitCargue, TituloCancelado, folderPath,
				"Se escribe el titulo a buscar,546946 se consulta estado diferente a aplicado");
		...
		searchElementGrid1(ClienteMercanciaState, CantInicial, folderPath,
				"caso 543825,543827, 543829,543830,546944,546945,546946 exitoso se puede observar informacion");
		searchElementGrid1(ClienteMercanciaState, CantActual, folderPath,
				"caso 543825,543829,543827,543830,546944,546945,546946 exitoso se puede observar informacion");
		click(btnClose, folderPath, "cerrar consulta");
	...
	@Step("Ver Bodega de cargue")
	public ExpedirPage UsuarioAdmin(File folderPath, String etiquetaPoliza, String poliza, String TituloHistorico,
			String SeccionA, String usuario2, String TituloGrabado, String TituloIncompleto, String Mercancias,
			String ModuloS) throws Exception {
		...
		// ValidacionObjetos(validarbtncargarE,validarbtndescargaE,"542494 Se valida la
		// no presencia de los botones de carge y descargue de archivos el caso 542494
		// es exitoso", folderPath);
		...
		ValidacionObjetos(validarbtndescarga, validarbtncargar,
				"542493 Se valida la presencia de los botones de carge y descargue de archivos", folderPath);
		...
		click(locatorVariable(lblOpciones, Mercancias), folderPath, "Click en Mercancias");
		ValidacionObjetos(validarbtndescargaf, validarbtncargarf,
				"542493 Se valida la presencia de los botones de carge y descargue de archivos", folderPath);
	...
	@Step("Ver Bodega de cargue")
	public ExpedirPage UsuarioEditarAdmin_545511(File folderPath, String usuario2, String ModuloT,
			String SubModuloExpedir, String Titulobonoprenda, String infogeneraltitulo, String lblbonoprenda,
			String LapsoTiempo, String TituloNoEditable, String TituloEstadoAnulado, String Mercancias, String tipoUser)
			throws Exception {

		writeText(SearchUsuary, usuario2, folderPath, "");
		searchElementGrid1(GridUsuario, tipoUser, folderPath,
				"Se valida tipo de usuario superadmin casos 545511, 545512, 545513, 545514");
		...
		scrollElementH(folderPath, lblModificarHistorico, "Se desplaza hasta modificar");
		click(lblModificarHistorico, folderPath, "click en modificar");
		click(locatorVariable(lblOpciones, infogeneraltitulo), folderPath,
				"Click en info general de titulo, Se visualiza campo fecha casos 545511, 545512, 545513, 545514");
		click(locatorVariable(lblOpciones, infogeneraltitulo), folderPath,
				"Click en info general de titulo, Se visualiza campo fecha casos 545511, 545512, 545513, 545514");

		// desplazarseVertical(0, 600);
		click(btnVerBonoPrenda, folderPath,
				"Click en ver bono prenda,casos exitosos 545511, 545512, 545513, 545514, el elemento actualmente no permite realizar accion alguna sobre el pero es editable y cambia de acuerdo al caso");
		// scrollElementH(folderPath, FechaVencimiento, "scroll hasta elemento casos
		// exitosos 545511, 545512, 545513, 545514, el elemento actualmente no permite
		// realizar accion alguna sobre el pero es editable y cambia de acuerdo al
		// caso");
		...
		click(lblModificarHistorico, folderPath, "click en modificar");
		click(locatorVariable(lblOpciones, infogeneraltitulo), folderPath,
				"Click en info general de titulo,Se visualiza fecha no editable 545513 ");
		...
		ValidacionObjetos(btnImpresionA, btnImpresionCDM, "caso exitoso 545515, 545516, 545517 se valida impresion",
				folderPath);
	...
	@Step("Crear expedir")
	public ExpedirPage MercanciaGenerica(File folderPath, String nitExpedir, String descripcion, String tipoMercanciaE,
			String SubModuloExpedir, String Titulobonoprenda) throws Exception
	...
	@Step("Ver Bodega de cargue")
	public ExpedirPage CP05(File folderPath, String usuario2, String ModuloT, String SubModuloExpedir,
			String Titulobonoprenda, String infogeneraltitulo, String lblbonoprenda, String LapsoTiempo,
			String TituloNoEditable) throws Exception {
	...
	@Step("Ver Bodega de cargue")
	public ExpedirPage CP08(File folderPath, String usuario2, String ModuloT, String SubModuloExpedir,
			String TituloNoEditable, String Prorroga, String lblbonoprenda, String LapsoTiempo,
			String infogeneraltitulo, String Mercancias) throws Exception {
		...
		// ValidacionObjetos(validarbtndescargaf,validarbtncargarf,"542494 Se valida la
		// presencia de los botones de carge y descargue de archivos, el caso 542494 es
		// exitoso", folderPath);
	...
	@Step("Ver Bodega de cargue")
	public ExpedirPage ProrrogasModificacion_546952(File folderPath, String TituloModificarProrroga, String SeccionP,
			String estadoA, String ValorProrroga) throws Exception {
	...
	@Step("Crear expedir")
	public ExpedirPage OperacionTitulo_552036(File folderPath, String TituloGrabado, String informacionGeneralE,
			String PersonaJuridica, String informacionG, String TituloHistorico) throws Exception {
		...
		ValidacionObjeto(btnTipoOperacion2, "Se valida boton de tipo de operacion caso 552036,552037,552038",
				folderPath);
		...
		ValidacionObjeto(btnTipoOperacion4,
				"Se valida alerta de cambios realizados, caso exitoso 552036,552037,552038,552039,552040", folderPath);
	...
	@Step("Crear expedir")
	public ExpedirPage AutorizacionLiberacion_548143(File folderPath, String TituloConLiberacionesPendientes,
			String informacionGeneralE, String PersonaJuridica, String informacionG, String SubModuloAutorizar,
			String AutoriPend, String DetalleMercancia) throws Exception {
		...
		// click(locatorVariable(lblsecciones, "Liberación"), folderPath, "Click en
		// elemento, se desplega lista ");

		writeText(TxtTituloLiberacion, TituloConLiberacionesPendientes, folderPath, "Se digita titulo de liberacion");
		click(btnSearchLiberacionButton, folderPath, "click en modificar");

		click(btnDetalleMercancia, folderPath,
				"Click en elemento, se desplega lista,Se visualiza informacion cambiada ");
		...
		// click(btnVisualizarAutorizacionPendiente, folderPath, "click en visualizar
		// autorizaciones, se visualiza caso 548144");
		// scrollElementH(folderPath, chxConfirmarLiberacion, "Se desplaza hasta
		// checkbox de caso 548144");
	...
	@Step("Coincidir")
    public ExpedirPage LpnDtlnumCoincidan(File folderPath,String TipoDeBodega,String estadoA,String Mercancias) throws Exception {
